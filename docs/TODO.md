...
- Use `docs/IOS_UPSTREAM_SYNC_QUEUE.md` as the current iOS upstream sync queue; next remaining slices are popup action-button frame sync, dictionary import/recommendation cleanup, bookshelf title rename, and highlight unlabeled-chapter grouping.
